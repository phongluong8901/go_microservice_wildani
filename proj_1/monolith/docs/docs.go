...
const docTemplate = `{
    ...
    "definitions": {
        ...
        "model.TransferRequest": {
            ...
            "properties": {
                "amount": {
                    "description": "Số tiền chuyển, bắt buộc và phải lớn hơn 0 (gt=0).",
                    "type": "number",
                    "example": 50000
                },
                "description": {
                    "description": "Mô tả giao dịch, có thể để trống.",
                    "type": "string",
                    "example": "Dinner split"
                },
                "idempotency_key": {
                    "description": "Khóa để ngăn chặn giao dịch trùng lặp, bắt buộc.",
                    "type": "string",
                    "example": "unique-uuid-key-123"
                },
                "receiver_email": {
                    "description": "Email người nhận, có validate bắt buộc (required) và đúng định dạng email (email)",
                    "type": "string",
        ...
        "model.UpdateUserRequest": {
            ...
            "properties": {
                "full_name": {
                    "description": "Họ tên bắt buộc phải có khi update",
                    "type": "string"
                }
            }
        },
